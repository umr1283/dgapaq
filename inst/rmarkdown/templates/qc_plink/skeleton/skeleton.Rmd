...
params:
  ...
  pca_components: 10
  pca_threshold: 3
  check_bim_script: !r system.file("perl", "HRC-1000G-check-bim.pl", package = "dgapaq")
  ref1kg_panel: NULL
  ref1kg_population: NULL
  ref1kg_genotypes: NULL
  ref1kg_legend: NULL
  ref1kg_fasta: NULL
  bin_path: !r list(bcftools = "bcftools", bgzip = "bgzip", plink = "plink1.9", gcta = "gcta64")
  cache: FALSE
  show_code: FALSE
  n_cores: 1
  dpi: 120
...
if (length(list.files(params[["input_files"]], pattern = ".bed")) != 0) {
...
system(
  command = paste(
    paste(
      "(cd", temp_directory, ";",
        gsub("plink", params[["bin_path"]][["plink"]], readLines(file.path(temp_directory, "Run-plink.sh"))),
      ")"
    ),
    collapse = ";"
  )
...
system(command = paste(
  ...
  "--reference-allele", 
      file.path(temp_directory, paste0("Force-Allele1-", params[["cohort_name"]], "_forimputation-1000G.txt")), 
  "--recode vcf",
  "--out", imputation_filename
))
...
if (length(list.files(params[["input_files"]], pattern = ".bim")) != 0) {
